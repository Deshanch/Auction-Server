...
here the current price is send by the server is directly as output stream to the input stream of the client
no array or any type of data stucture is passed to the inputstream of the client by server when symbol is
send to the server.only current price or -1 is passed from the server.
*/
package com.client;
//import packages
